...
const registrationSuccessEmailBody = (userData) => {
  ...
  <html>
    ...
    <body>
      <div class="container">
        <h1>Welcome to ${config_1.default.server_name}</h1>
        <p>Hello ${(_a = userData === null || userData === void 0 ? void 0 : userData.name) !== null && _a !== void 0 ? _a : userData === null || userData === void 0 ? void 0 : userData.email},</p>
        ...
        <p>If you have any questions, please contact us at <a href="mailto:${config_1.default.smtp.auth.user}">${config_1.default.smtp.auth.user}</a>.</p>
      </div>
    </body>
  </html>
`;
